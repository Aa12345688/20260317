...
export function InventoryStats({ freshItems, expiredItems }: InventoryStatsProps) {
    return (
        <div className="grid grid-cols-2 gap-3 px-4 py-2">
            <div className="bg-[var(--card)]/50 backdrop-blur-xl border border-white/10 rounded-2xl p-3.5 shadow-[0_15px_30px_-5px_rgba(0,0,0,0.5)] relative overflow-hidden group hover:translate-y-[-2px] transition-all">
                <div className="absolute top-2.5 right-2.5 w-1 h-1 rounded-full bg-primary shadow-[0_0_12px_var(--primary-glow)] animate-pulse" />
